...
<div style="display:flex; height:100vh; overflow:hidden;">
    ...
    <aside class="ptm-sidebar" style="width:240px; min-width:240px; display:flex; flex-direction:column;">
        <div class="ptm-sidebar-header" style="padding:18px 16px 14px;">
            <div style="display:flex; align-items:center; gap:10px;">
                ...
                <div>
                    ...
                    <div style="font-size:10px; color:var(--muted); font-family:var(--mono);">Client Portal</div>
                </div>
            </div>
        </div>
        ...
        @php
            ...
            $sidebarProjects = auth()->user()->clientProjects()->orderBy('name')->get(['projects.id', 'projects.name']);
        ...
        <nav style="flex:1; padding:10px 8px; display:flex; flex-direction:column; gap:2px; overflow-y:auto;">
            <a href="{{ route('client.dashboard', $slug) }}" class="ptm-nav-link {{ request()->routeIs('client.dashboard') ? 'active' : '' }}">
            ...
            @forelse($sidebarProjects as $sidebarProject)
                <a href="{{ route('client.projects.show', [$slug, $sidebarProject->id]) }}"
        ...
        <div style="padding:12px 12px 14px; border-top:1px solid var(--border);">
            <div style="display:flex; align-items:center; gap:10px; margin-bottom:10px;">
                ...
                <div>
                    ...
                    <div style="font-size:10px; color:var(--muted); font-family:var(--mono);">Client</div>
                </div>
            </div>
