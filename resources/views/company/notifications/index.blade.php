<x-company-layout title="Notifications">
    ...
    <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:20px;">
        ...
        <form method="POST" action="{{ route('company.notifications.mark-all-read', auth()->user()->company->slug) }}">
            @csrf
    ...
    <div class="ptm-card">
        ...
        <div style="padding:16px 20px; border-bottom:1px solid var(--border); display:flex; align-items:flex-start; gap:14px; {{ $notification->is_read ? '' : 'background:rgba(74,222,128,0.02);' }}">
            ...
            <div style="flex:1; min-width:0;">
                ...
                <div style="display:flex; align-items:center; gap:10px;">
                    ...
                    <form method="POST" action="{{ route('company.notifications.mark-as-read', [auth()->user()->company->slug, $notification]) }}" style="display:inline;">
                        @csrf
                        @method('PATCH')
        ...
        <div style="padding:60px 20px; text-align:center;">
            ...
            <div style="font-size:12px; color:var(--muted);">You'll see updates about your tasks and projects here</div>
        </div>
        @endforelse
    </div>
    ...
    function markAsRead(id) {
        ...
        fetch('/' + slug + '/admin/notifications/' + id + '/read', {
            method: 'PATCH',
            headers: {
