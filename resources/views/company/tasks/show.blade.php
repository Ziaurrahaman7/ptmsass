        ...
        <div>
            ...
            <div class="ptm-card">
                ...
                <div style="padding:18px;">
                    ...
                    <form method="POST" action="{{ route('company.tasks.comments.store', [auth()->user()->company->slug, $task]) }}" style="margin-bottom:20px;" data-members="{{ e(($members ?? collect())->map(fn($m)=>['id'=>$m->id,'name'=>$m->name,'email'=>$m->email])->values()->toJson()) }}">
                        @csrf
