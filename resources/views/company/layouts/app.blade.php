...
<div style="display:flex; height:100vh; overflow:hidden;">
    ...
    <aside class="ptm-sidebar" style="width:240px; min-width:240px; display:flex; flex-direction:column; overflow:hidden;">
        ...
        <nav style="flex:1; padding:10px 8px; overflow-y:auto; display:flex; flex-direction:column; gap:2px;">
            <a href="{{ route('company.dashboard') }}" class="ptm-nav-link {{ request()->routeIs('company.dashboard') ? 'active' : '' }}">
            ...
            <a href="{{ route('company.projects.index') }}" class="ptm-nav-link {{ request()->routeIs('company.projects.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('company.tasks.index') }}" class="ptm-nav-link {{ request()->routeIs('company.tasks.index') ? 'active' : '' }}">
            ...
            <a href="{{ route('company.members.index') }}" class="ptm-nav-link {{ request()->routeIs('company.members.*') ? 'active' : '' }}">
